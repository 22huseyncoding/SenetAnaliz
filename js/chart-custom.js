...
if (jQuery("#high-basicline-chart").length && Highcharts.chart("high-basicline-chart", {
	...
	function showValues() {
		$("#alpha-value").php(chart.options.chart.options3d.alpha), $("#beta-value").php(chart.options.chart.options3d.beta), $("#depth-value").php(chart.options.chart.options3d.depth)
	}
